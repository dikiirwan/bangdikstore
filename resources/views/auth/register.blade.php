        ...
        <div class="col-lg-4">
          ...
          <form method="POST" action="{{ route('register') }}" class="mt-3">
            ...
            <div class="form-group" v-if="is_store_open">
              ...
              <input type="text" name="store_name" id="store_name" v-model="store_name" class="form-control @error('store_name') is-invalid @enderror" required autocomplete autofocus>
