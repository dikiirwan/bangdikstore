                  ...
                  <div class="col-12 mt-2">
                    ...
                    >
                      <li class="nav-item" role="presentation">
                        <a
                          ...
                          id="pills-sellproduct-tab"
                          data-toggle="pill"
                          href="#pills-sellproduct"
                          role="tab"
                          aria-controls="pills-sellproduct"
                          aria-selected="true"
                          >Sell Product</a
                        >
                      </li>
                      <li class="nav-item" role="presentation">
                        <a
                          class="nav-link"
                          id="pills-buyproduct-tab"
                          data-toggle="pill"
                          href="#pills-buyproduct"
                          role="tab"
                          aria-controls="pills-buyproduct"
                          aria-selected="false"
                          >Buy Product</a
                        >
                      </li>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                      ...
                      <div
                        ...
                        id="pills-buyproduct"
                        role="tabpanel"
                        aria-labelledby="pills-buyproduct-tab"
                      >
